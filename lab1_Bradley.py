...
my_name = "Bradley" # Change to your name
my_github_account = "https://github.com/NeuromancerB" # Change to your GitHub account
my_hobby = "manga" # Change to your hobby
...
I am {my_name}. I really like {my_hobby}.

My experience level in coding is {my_coding_experience}, and thats being nice.
I would love to learning coding {hours_coding_per_week} hours per week.
The projects I'd like to do in this term are: {project_interested} and {project_another_interested}.
Here is my GitHub account: {my_github_account}.
